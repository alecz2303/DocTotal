...
- [!] Definir política de conservación y retención documental.
...
- [ ] Definir y validar estrategia de backup/restauración para datos y archivos clínicos.
- [ ] Definir política operativa de retención/eliminación.
...
- [ ] Estrategia operativa verificable de backup y restauración.
- [ ] Política de retención y eliminación de expedientes/archivos después de cancelación.
...
- [!] Retención/eliminación de información clínica y comercial.
...
- DocTotal manejará información clínica y documentos privados.
- DT-35 endureció el arranque/runtime, pero no constituye una estrategia de backup/restauración.
- La documentación histórica repite backups, restauración y retención como pendientes reales.
- Este bloque puede diseñarse sin inventar requisitos legales: primero infraestructura verificable, pruebas de restauración y límites operativos explícitos; las políticas legales definitivas pueden seguir como decisión separada.

El siguiente ID DT debe obtenerse exclusivamente desde Jira cuando se decida crear ese ticket.
